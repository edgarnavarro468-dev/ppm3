...
class User(Base):
    ...
    public_code = Column(String(20), unique=True, index=True, default="", nullable=False)
...
class Settlement(Base):
    ...
    from_confirmed = Column(Boolean, default=False, nullable=False)
    to_confirmed = Column(Boolean, default=False, nullable=False)
...
ensure_sqlite_column("users", "public_code", "public_code VARCHAR(20) NOT NULL DEFAULT ''")
...
ensure_sqlite_column("group_members", "role", "role VARCHAR(20) NOT NULL DEFAULT 'member'")
ensure_sqlite_column("group_members", "status", "status VARCHAR(20) NOT NULL DEFAULT 'active'")
...
ensure_sqlite_column("settlements", "from_confirmed", "from_confirmed BOOLEAN NOT NULL DEFAULT 0")
ensure_sqlite_column("settlements", "to_confirmed", "to_confirmed BOOLEAN NOT NULL DEFAULT 0")
